---
title: "Contrat client sophrologue : est-ce obligatoire et que doit-il contenir ?"
description: "Un sophrologue ou naturopathe est-il obligé d'avoir un contrat avec ses clients ? Ce que dit le droit de la consommation, quand les CGV sont obligatoires, et ce que doit contenir un contrat client pour être en règle."
date: "2026-08-27"
slug: "contrat-client-sophrologue-obligations"
...
Le droit de la consommation distingue deux situations qui n'entraînent pas les mêmes obligations.

**Les séances en présentiel**, conclues directement en cabinet, ne sont pas soumises aux règles des contrats à distance. Vous n'avez pas d'obligation légale de remettre un contrat écrit pour chaque séance individuelle.

Cependant, vous restez soumis à l'obligation générale d'information précontractuelle : le client doit pouvoir connaître vos tarifs, les caractéristiques de votre prestation et vos modalités avant d'acheter.

**Les séances en ligne, les forfaits vendus via votre site, les programmes payants à distance** — tout ce qui relève d'un contrat conclu à distance ou hors établissement entraîne des obligations supplémentaires : CGV obligatoires, droit de rétractation à mentionner, confirmation écrite de la commande.
...
**Description de la prestation** — ce que vous proposez, le format, la durée. Cette description doit être précise sans formuler de promesse de résultat médical.

**Tarifs** — le prix TTC, avec la mention "TVA non applicable — art. 293B CGI" si vous êtes en franchise de TVA.

**Modalités de paiement** — à quel moment, par quel moyen.
...
Votre contrat ou vos CGV doivent décrire votre prestation avec précision — mais sans créer d'attente médicale. La formulation de votre prestation dans vos CGV a la même importance juridique que celle de votre site.

Un exemple de formulation adaptée : "La sophrologie est une méthode d'accompagnement qui vise à développer les ressources personnelles du client. Les séances ne constituent pas un acte médical et ne se substituent pas à un suivi médical ou psychologique."

Cette phrase ne promet rien de médical — elle situe clairement votre rôle.

## Et si un client ne paie pas ou conteste ?
...
- [Afficher ses tarifs de sophrologue : obligation légale ou choix stratégique ?](/blog/afficher-tarifs-sophrologue)
- [Droit de rétractation d'un client en sophrologie : ce que la loi impose](/blog/droit-retractation-client-sophrologue-loi)
