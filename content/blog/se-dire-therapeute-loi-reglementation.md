---
title: "Peut-on se dire thérapeute sans diplôme reconnu ? Ce que la loi permet"
description: "Le titre de thérapeute n'est pas un titre protégé en France. Mais tout n'est pas permis pour autant. Ce que la loi autorise, ce qui crée un risque juridique, et comment présenter son activité correctement."
date: "2026-08-24"
slug: "se-dire-therapeute-loi-reglementation"
tags: ["Juridique", "Conformité", "Communication"]
---

Le titre de thérapeute n'est pas protégé par la loi en France : n'importe qui peut l'utiliser sans formation spécifique ni sanction pénale liée au seul usage du terme. Cette liberté a cependant des limites précises, définies par le Code de la consommation et le Code de la santé publique.

> **En bref :** Se dire thérapeute est légal en France car le titre n'est pas protégé, mais son usage peut engager des sanctions si la communication crée une fausse impression sur vos qualifications ou se réclame d'actes médicaux réservés aux professionnels de santé.

## "Thérapeute" : un titre non réglementé

Contrairement à "médecin", "psychologue", "infirmier" ou "kinésithérapeute", le mot "thérapeute" ne fait pas l'objet d'une protection légale spécifique en droit français. Il n'existe pas de texte qui réserve ce terme à une profession particulière ou qui exige une qualification précise pour l'utiliser.

En théorie, n'importe qui peut se présenter comme thérapeute. En pratique, c'est plus nuancé.
...
**Le risque d'exercice illégal de la médecine.** Si vous vous présentez comme thérapeute et que votre communication laisse entendre que vous diagnostiquez des maladies, que vous prescrivez des traitements, ou que vous soignez des pathologies identifiées, vous entrez dans le périmètre des actes médicaux réservés aux professionnels de santé. Le terme "thérapeute" seul ne suffit pas à créer ce risque, mais il peut y contribuer selon le contexte.

**Le risque de pratique commerciale trompeuse.** Si votre usage du terme "thérapeute" induit le consommateur en erreur sur vos qualifications réelles, sur la nature de votre accompagnement, ou sur les résultats attendus, vous pouvez être sanctionné sur le fondement du Code de la consommation. L'intention ne compte pas : seul l'effet que le message produit sur le lecteur est évalué.

## "Thérapeute" seul versus "thérapeute" qualifié

La nuance se joue souvent dans l'association de mots.
