...
1. **Faites l'inventaire** de tout ce que vous collectez : formulaire de contact, prise de RDV, newsletter, notes de séance, fichier clients, outils de paiement.
2. **Rédigez une politique de confidentialité** simple. Des générateurs en ligne existent, mais adaptez-les à votre réalité.
3. **Vérifiez vos consentements** : est-ce que les personnes inscrites à votre newsletter ont vraiment donné leur accord explicite ?
4. **Ajoutez les liens** vers vos mentions légales et politique de confidentialité en bas de toutes vos pages.
