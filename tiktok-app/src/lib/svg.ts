...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="${W / 2}" y="204" text-anchor="middle" font-size="22" fill="${t.ca}" font-family="${FONT}" font-weight="700" letter-spacing="9" opacity="0.85">${esc(t.la)}</text>
  <rect x="${W / 2 - 44}" y="222" width="88" height="2" fill="${t.ca}" rx="1" opacity="0.40"/>
