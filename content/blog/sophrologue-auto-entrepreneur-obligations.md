---
title: "Sophrologue auto-entrepreneur : statut, obligations et limites à connaître"
description: "Le statut auto-entrepreneur est-il adapté pour exercer la sophrologie ou la naturopathie ? Plafond de chiffre d'affaires, TVA, obligations déclaratives : ce que tout praticien bien-être doit savoir avant de s'installer."
date: "2026-09-24"
slug: "sophrologue-auto-entrepreneur-obligations"
...
C'est la contrainte principale du statut micro-entrepreneur : votre chiffre d'affaires annuel ne peut pas dépasser un certain seuil.

Pour les prestations de services (ce que sont les séances de sophrologie), le plafond est fixé à **77 700 euros hors taxes par an** (seuil 2026, révisé chaque année). Au-delà, vous devez changer de régime fiscal et juridique.

Si vous approchez de ce seuil, anticipez : le changement de statut prend du temps et les implications fiscales méritent d'être préparées avec un comptable.
...
Sur votre site internet, si vous affichez vos tarifs, la mention "TVA non applicable" doit être visible. C'est une obligation légale et une information que vos clients ont le droit d'avoir.

## Les obligations déclaratives

En micro-entreprise, vous déclarez votre chiffre d'affaires mensuellement ou trimestriellement sur le site de l'URSSAF (ou via l'application AutoEntrepreneur). Le montant des cotisations sociales est calculé en pourcentage de ce chiffre d'affaires déclaré.

Si vous ne déclarez pas (même un mois à zéro), vous pouvez faire l'objet d'une régularisation ou d'une pénalité. Déclaration à zéro : obligatoire même si vous n'avez pas encaissé un centime.

## Ce que le statut ne couvre pas

**L'assurance professionnelle.** Le statut auto-entrepreneur ne vous protège pas automatiquement contre les accidents ou les litiges avec vos clients. Une assurance responsabilité civile professionnelle reste nécessaire, indépendamment de votre statut juridique.
