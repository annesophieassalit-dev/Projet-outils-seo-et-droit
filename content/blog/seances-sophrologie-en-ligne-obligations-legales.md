---
title: "Séances de sophrologie en ligne : obligations légales et bonnes pratiques"
description: "Proposer des séances de sophrologie ou de naturopathie en visioconférence crée des obligations spécifiques : CGV, droit de rétractation, RGPD, protection des données. Ce que les praticiens doivent mettre en place."
date: "2026-09-28"
slug: "seances-sophrologie-en-ligne-obligations-legales"
...
## Les CGV deviennent obligatoires
...
Les séances en ligne impliquent la transmission de données personnelles via vos outils numériques : adresse email, historique des échanges, nom, parfois des informations de santé.

Quelques points à vérifier :

**L'outil de visioconférence que vous utilisez.** Zoom, Google Meet, Teams : ces outils collectent des données. Si vous utilisez un outil hébergé en dehors de l'Union européenne, vous avez des obligations de transfert de données à mentionner dans votre politique de confidentialité.

**Les enregistrements de séance.** Enregistrer une séance sans l'accord du client est une violation de sa vie privée. Si vous souhaitez enregistrer pour votre usage personnel, demandez un accord écrit explicite et précisez les conditions de conservation et de suppression.

**Les emails et messageries.** Si vous communiquez avec vos clients par email ou messagerie, ces échanges contiennent des données personnelles. Précisez dans votre politique de confidentialité combien de temps vous conservez ces communications.
...
Si vous venez de lancer des séances en ligne, ou si vous avez développé cette offre progressivement sans revoir votre cadre juridique, c'est le moment de vérifier que vos CGV, votre politique de confidentialité et vos mentions légales couvrent bien cette réalité.
