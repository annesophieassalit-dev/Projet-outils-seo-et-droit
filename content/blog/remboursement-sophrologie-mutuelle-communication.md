---
title: "Remboursement sophrologie par les mutuelles : ce qu'on peut dire sans promettre"
description: "Certaines mutuelles remboursent les séances de sophrologie. Mais comment en parler sur son site sans créer une fausse promesse ? Ce que la loi permet, et les formulations qui évitent le risque."
date: "2026-09-03"
slug: "remboursement-sophrologie-mutuelle-communication"
...
## Pourquoi c'est risqué d'en faire un argument commercial
...
La règle est simple : informer, sans promettre.

**Formulations acceptables :**

"Certaines mutuelles prévoient un forfait pour les séances de sophrologie. Je vous invite à vérifier auprès de votre organisme les conditions de prise en charge."

"Des remboursements partiels existent selon les contrats de complémentaire santé. Renseignez-vous auprès de votre mutuelle."

"Je peux vous fournir une facture pour faciliter votre demande de remboursement auprès de votre mutuelle, si celle-ci prend en charge les séances de sophrologie."

Ces formulations sont vraies, utiles pour le client, et ne créent pas d'attente que vous ne pouvez pas garantir.
...
Ce que vous devez faire, en revanche : émettre une facture à la demande du client. Cette facture lui permet de la transmettre à sa mutuelle, qui décidera ensuite de rembourser ou non selon les termes de son contrat.

Votre responsabilité s'arrête là. La décision de remboursement appartient à la mutuelle, pas à vous.
...
Si vous avez déjà mentionné le remboursement mutuelle sur votre site ou vos réseaux, c'est le moment de relire comment vous l'avez formulé.
