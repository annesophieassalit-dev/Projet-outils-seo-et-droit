...
## Page "À propos" : créer la confiance sans sur-vendre
...
C'est la page la plus exposée juridiquement — et celle où les formulations risquées s'accumulent le plus souvent.

**Structure recommandée pour chaque service :**
1. Le nom de l'accompagnement
2. Pour qui il est pensé (en termes de situations vécues, pas de pathologies)
3. Comment ça se passe concrètement (durée, format, déroulé)
4. Ce que la personne peut en retirer (expérience, ressources, chemin — pas de résultat garanti)

**La ligne à ne pas franchir :**
Décrire ce que votre accompagnement "traite", "soigne" ou "guérit" est interdit. Décrire ce qu'il "explore", "soutient", "accompagne" est votre terrain.

Un exemple : "Accompagnement pour les personnes qui traversent une période de burn-out" est juste. "Traitement du burn-out en 6 séances" ne l'est pas.

## Page tarifs : affichez, c'est un avantage
...
Simple et visible. Un formulaire de contact ou un lien vers votre agenda en ligne suffit — mais il doit être accessible depuis chaque page, pas seulement depuis un menu caché.

Si vous collectez des données via ce formulaire (nom, email, message), vous traitez des données personnelles : votre politique de confidentialité doit le mentionner.
...
## Le blog : la page qui fait venir vos clients depuis Google
...
La difficulté quand on rédige ses propres textes : on ne sait pas toujours quelle formulation est sûre et laquelle est exposée. La frontière entre "j'accompagne" et "je traite" est parfois subtile.
