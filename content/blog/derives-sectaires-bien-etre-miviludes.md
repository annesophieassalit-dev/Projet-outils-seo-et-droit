---
title: "Dérives sectaires et bien-être : comment un praticien évite d'être mis en cause"
description: "La MIVILUDES surveille le secteur du bien-être. Comment un sophrologue ou naturopathe se distingue des pratiques signalées ? Les critères de vigilance, les formulations à risque, et ce qui protège un praticien sérieux."
date: "2026-10-01"
slug: "derives-sectaires-bien-etre-miviludes"
...
## Les formulations qui rapprochent d'une dérive

Dans la communication d'un praticien bien-être, certaines formulations envoient des signaux de risque, pas parce qu'elles sont fausses, mais parce qu'elles peuvent être interprétées de façon problématique.

**Promettre ce que la médecine n'a pas pu faire.** "Pour ceux qui ont tout essayé sans résultat", "la méthode qui réussit là où les autres ont échoué", ces formulations positionnent votre pratique comme un recours après l'échec médical. Elles attirent des personnes vulnérables et créent des attentes dangereuses.

**Déconseiller le suivi médical.** Même formulé prudemment, "la médecine n'a pas toujours les réponses", "les médicaments ne traitent que les symptômes", tout discours qui fragilise la confiance dans le suivi médical peut être utilisé contre vous.

**Vendre des programmes longs comme condition du résultat.** "Il faut au minimum 20 séances pour que ça fonctionne", "les résultats ne viennent qu'au bout d'un an", quand ces affirmations s'accompagnent d'une pression à l'engagement financier, elles entrent dans les critères de vigilance.

## Ce qui protège un praticien sérieux

La meilleure protection n'est pas juridique en premier lieu. C'est la clarté de votre positionnement.

**Référencez vers le médical quand c'est nécessaire.** Un praticien bien-être sérieux sait reconnaître les situations qui dépassent son périmètre et oriente vers des professionnels de santé. Cela se voit dans votre communication : une mention du type "la sophrologie s'inscrit en complément d'un suivi médical et ne s'y substitue pas" n'est pas une contrainte, c'est une marque de sérieux.

**Restez dans le registre de l'accompagnement.** Vos textes décrivent ce que vous proposez, pas ce que vous guérissez. La frontière est claire, et elle doit l'être aussi dans votre communication.

**Ne créez pas de dépendance.** La durée d'un accompagnement est discutée avec le client selon sa situation, pas imposée comme condition du résultat. Votre client garde la maîtrise de son parcours.

**Proposez un premier contact sans engagement fort.** Un premier rendez-vous, un test gratuit, une présentation de votre approche, sans pression à l'achat d'un programme complet dès le départ.

## Ce que vous pouvez mentionner sur votre site
